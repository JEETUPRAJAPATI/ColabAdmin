  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Roles & Permissions', icon: RiLockPasswordLine, path: '/roles' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'SEO Manager', icon: RiSearchEyeLine, path: '/seo' },
      ],
    },
    {
      title: 'Communication',
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Coupons', icon: RiCoupon3Line, path: '/coupons' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Languages', icon: RiTranslate2Line, path: '/languages' },
      ],
    },
    {
      title: 'Support',
